...
# Now use direct imports from protocols
import validator
...
from driver import handle_driver_car_get,handle_driver_car_info_save,handle_driver_offline,handle_driver_online,handle_driver_route_get,handle_driver_route_save,handle_driver_schedule_get,handle_driver_schedule_save
from ride import handle_ride_already_taken,handle_ride_cancel_active,handle_ride_location_history,handle_ride_location_latest,handle_ride_location_share,handle_ride_lock_acquire,handle_ride_lock_release,handle_ride_request_accept,handle_ride_request_cancel,handle_ride_request_complete,handle_ride_request_create,handle_ride_request_decline,handle_ride_request_expire,handle_ride_request_notify_drivers,handle_ride_request_status,handle_ride_status_update,handle_ride_requests_get_pending
...
from emergency import handle_emergency_contact_add,handle_emergency_contact_get,handle_emergency_contact_remove,handle_emergency_resolve,handle_emergency_test_contact,handle_emergency_trigger
